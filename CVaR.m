function [x_optimal,fval,var] = CVaR(mu, Q, currentPrices)
    tic
    num_asset = size(mu, 1);
    rho = corrcov(Q);
    nPaths = 2000;
    ...
    % A(2 * nPaths + 1, nPaths + 1: nPaths + num_asset) = -mu';
    ...
    [x,fval] = linprog(f, A, b, Aeq, beq, [-1000000 * ones(nPaths,1); zeros(20, 1); -1000000], []);
